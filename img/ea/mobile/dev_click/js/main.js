...
//
//				$('#imgs').append('<img src="../../mobile/dev_click/img/look/look_' + value + '.jpg" id="' + index + '_' + value + '" />');
//			}
//		});
//	});
//
//
//	$('#imgs').append('<img src="../../mobile/dev_click/img/hair/hair_000.jpg" id="hair_000" />');
//	$('#imgs').append('<img src="../../mobile/dev_click/img/hair/hair_black.jpg" id="hair_black" />');
//	$('#imgs').append('<img src="../../mobile/dev_click/img/hair/hair_blonde.jpg" id="hair_blonde" />');
//	$('#imgs').append('<img src="../../mobile/dev_click/img/hair/hair_dkbrown.jpg" id="hair_dkbrown" />');
//	$('#imgs').append('<img src="../../mobile/dev_click/img/hair/hair_ltbrown.jpg" id="hair_ltbrown" />');
//	$('#imgs').append('<img src="../../mobile/dev_click/img/hair/hair_red.jpg" id="hair_red" />');
//
//
...
////				console.log('index = ' + index + '     value = ' + value);
//
//				$('.sectProdContainer').append('<img src="../../mobile/dev_click/img/prod/' + value + '" id="' + index + '_' + value + '" />');
//			}
//		});
//	});
//}
...
//		console.log('PING! there are no looks available');
		...
		$('#imgs').append('<img src="../../mobile/dev_click/img/look/look_000.jpg" id="look000" />');
		$('#hair').append('<img src="../../mobile/dev_click/img/hair/hair_000.jpg" />');
...
//					console.log('hair = ' + hair);
					...
					$('#imgs').append('<img src="../../mobile/dev_click/img/look/look_' + value + '.jpg" id="' + index + '_' + value + '" />');
					$('#hair').append('<img src="../../mobile/dev_click/img/hair/hair_' + hair + '.jpg" />');
				}
			});
		});
...
//						sectProdContainer.append('<div class="sectProd"><a href="#thisProduct"><div class="sectProdHed" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')">' + tempProd['product'] + '</div></a><a href="#thisProduct"><img src="../../mobile/dev_click/img/prod/' + value + '" id="' + tempProd['product'] + ' - ' + tempProd['shade'] + '" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')" /></a><input type="checkbox" id="' + tempProd['product'] + ' ' + tempProd['shade'] + '" name="' + tempProd['product'] + '" value="' + tempProd['shade'] + '"><label for="' + tempProd['product'] + ' ' + tempProd['shade'] + '" onClick="toggleCheck(this)">' + tempProd['shade'] + '</label></div>');
//						sectProdContainer.append('<div class="sectProd"><a href="#thisProduct"><div class="sectProdHed" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')">' + tempProd['product'] + '</div></a><a href="#thisProduct"><img src="../../mobile/dev_click/img/prod/' + value + '" id="' + tempProd['product'] + ' - ' + tempProd['shade'] + '" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')" /></a><input type="checkbox" id="' + tempProd['product'] + ' ' + tempProd['shade'] + '" name="' + tempProd['product'] + '" value="' + tempProd['shade'] + '" onClick="toggleCheck(this)"><label for="' + tempProd['product'] + ' ' + tempProd['shade'] + '" onClick="toggleCheck(this)">' + tempProd['shade'] + '</label></div>');
						sectProdContainer.append('<div class="sectProd"><a href="#thisProduct"><div class="sectProdHed" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')">' + tempProd['product'] + '</div></a><a href="#thisProduct"><img src="../../mobile/dev_click/img/prod/' + value + '" id="' + tempProd['product'] + ' - ' + tempProd['shade'] + '" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')" /></a><input type="checkbox" id="' + tempProd['product'] + ' ' + tempProd['shade'] + '" name="' + tempProd['product'] + '" value="' + tempProd['shade'] + '" onClick="toggleCheck(event, this)"><label for="' + tempProd['product'] + ' ' + tempProd['shade'] + '">' + tempProd['shade'] + '</label></div>');
//						sectProdContainer.append('<div class="sectProd"><a href="#thisProduct"><div class="sectProdHed" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')">' + tempProd['product'] + '</div></a><a href="#thisProduct"><img src="../../mobile/dev_click/img/prod/' + value + '" id="' + tempProd['product'] + ' - ' + tempProd['shade'] + '" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')" /></a><input type="checkbox" id="' + tempProd['product'] + ' ' + tempProd['shade'] + '" name="' + tempProd['product'] + '" value="' + tempProd['shade'] + '" ><label for="' + tempProd['product'] + ' ' + tempProd['shade'] + '">' + tempProd['shade'] + '</label></div>');

//						sectProdContainer.append('<div class="sectProd"><a href="#thisProduct"><div class="sectProdHed" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')">' + tempProd['product'] + '</div></a><a href="#thisProduct"><img src="../../mobile/dev_click/img/prod/' + value + '" id="' + tempProd['product'] + ' - ' + tempProd['shade'] + '" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')" /></a><label for="' + tempProd['product'] + ' ' + tempProd['shade'] + '">' + tempProd['shade'] + '</label><input type="checkbox" id="' + tempProd['product'] + ' ' + tempProd['shade'] + '" name="' + tempProd['product'] + '" value="' + tempProd['shade'] + '" onClick="toggleCheck(this)"></div>');
...
//						sectProdContainer.append('<div class="sectProd"><a href="#thisProduct"><div class="sectProdHed" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')">' + tempProd['product'] + '</div></a><a href="#thisProduct"><img src="../../mobile/dev_click/img/prod/prod_000.jpg" id="' + tempProd['product'] + ' - ' + tempProd['shade'] + '" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')" /></a><input type="checkbox" id="' + tempProd['product'] + ' ' + tempProd['shade'] + '" name="' + tempProd['product'] + '" value="' + tempProd['shade'] + '"><label for="' + tempProd['product'] + ' ' + tempProd['shade'] + '" onClick="toggleCheck(this)">' + tempProd['shade'] + '</label></div>');
//						sectProdContainer.append('<div class="sectProd"><a href="#thisProduct"><div class="sectProdHed" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')">' + tempProd['product'] + '</div></a><a href="#thisProduct"><img src="../../mobile/dev_click/img/prod/prod_000.jpg" id="' + tempProd['product'] + ' - ' + tempProd['shade'] + '" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')" /></a><input type="checkbox" id="' + tempProd['product'] + ' ' + tempProd['shade'] + '" name="' + tempProd['product'] + '" value="' + tempProd['shade'] + '" onClick="toggleCheck(this)"><label for="' + tempProd['product'] + ' ' + tempProd['shade'] + '" onClick="toggleCheck(this)">' + tempProd['shade'] + '</label></div>');
						sectProdContainer.append('<div class="sectProd"><a href="#thisProduct"><div class="sectProdHed" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')">' + tempProd['product'] + '</div></a><a href="#thisProduct"><img src="../../mobile/dev_click/img/prod/prod_000.jpg" id="' + tempProd['product'] + ' - ' + tempProd['shade'] + '" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')" /></a><input type="checkbox" id="' + tempProd['product'] + ' ' + tempProd['shade'] + '" name="' + tempProd['product'] + '" value="' + tempProd['shade'] + '" onClick="toggleCheck(event, this)"><label for="' + tempProd['product'] + ' ' + tempProd['shade'] + '">' + tempProd['shade'] + '</label></div>');
//						sectProdContainer.append('<div class="sectProd"><a href="#thisProduct"><div class="sectProdHed" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')">' + tempProd['product'] + '</div></a><a href="#thisProduct"><img src="../../mobile/dev_click/img/prod/prod_000.jpg" id="' + tempProd['product'] + ' - ' + tempProd['shade'] + '" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')" /></a><input type="checkbox" id="' + tempProd['product'] + ' ' + tempProd['shade'] + '" name="' + tempProd['product'] + '" value="' + tempProd['shade'] + '" ><label for="' + tempProd['product'] + ' ' + tempProd['shade'] + '">' + tempProd['shade'] + '</label></div>');

//						sectProdContainer.append('<div class="sectProd"><a href="#thisProduct"><div class="sectProdHed" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')">' + tempProd['product'] + '</div></a><a href="#thisProduct"><img src="../../mobile/dev_click/img/prod/prod_000.jpg" id="' + tempProd['product'] + ' - ' + tempProd['shade'] + '" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')" /></a><label for="' + tempProd['product'] + ' ' + tempProd['shade'] + '">' + tempProd['shade'] + '</label><input type="checkbox" id="' + tempProd['product'] + ' ' + tempProd['shade'] + '" name="' + tempProd['product'] + '" value="' + tempProd['shade'] + '" onClick="toggleCheck(this)"></div>');
//						sectProdContainer.append('<div class="sectProd"><a href="#thisProduct"><div class="sectProdHed" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')">' + tempProd['product'] + '</div></a><a href="#thisProduct"><img src="../../mobile/dev_click/img/prod/prod_000.jpg" id="' + tempProd['product'] + ' - ' + tempProd['shade'] + '" onClick="openProduct(\'' + tempProd['product'] + '\', \'' + tempProd['shade'] + '\')" /></a><label for="' + tempProd['product'] + ' ' + tempProd['shade'] + '">' + tempProd['shade'] + '</label><input type="checkbox" id="' + tempProd['product'] + ' ' + tempProd['shade'] + '" name="' + tempProd['product'] + '" value="' + tempProd['shade'] + '"></div>');
					}
				});
			}
...
//			console.log('this[\'product\'] = ' + this['product'] + '   this[\'shade\'] = ' + this['shade'] + '   this[\'image\'] = ' + this['image']);
			...
			if (this['image'] !== '') {
				$('.prodDetailImage').append('<img src="../../mobile/dev_click/img/prod/' + this['image'] + '" />');
			} else {
				$('.prodDetailImage').append('<img src="../../mobile/dev_click/img/prod/prod_000.jpg" />');
			}
...
//						<a href="#thisProduct" onClick="openProduct(\'' + this['product'] + '\', \'' + this['shade'] + '\')"><img src="../../mobile/dev_click/img/prod/' + this['image'] + '" /></a>
...
//				</div>');
			...
			$('.listContainer').append('<div class="prodList"><div class="prodListImg"><a href="#thisProduct" onClick="openProduct(\'' + this['product'] + '\', \'' + this['shade'] + '\')"><img src="../../mobile/dev_click/img/prod/' + this['image'] + '" /></a><button type="button" class="prodListBtn" id="removeMe" onClick="removeFromList(event)">Remove From List</button></div><a href="#thisProduct" onClick="openProduct(\'' + this['product'] + '\', \'' + this['shade'] + '\')"><div class="prodListDescr clearFix"><h1>' + this['product'] + '</h1><h2>' + this['shade'] + '</h2><p>' + this['descr2'] + '</p></div></a></div>');
