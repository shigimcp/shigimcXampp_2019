...
<head>
	...
	<title>M  |  Mariah Carey Beauty</title>
...
<body id="mbrand" class="brand_home">
<div id="container"> 
	...
	<div id="nav"> 
		...
		<ul class="navlist" id="nav_sub">
			<li><a href="M/TheFragrance.php" id="s_fragrance"><span>The Fragrance</span></a></li>
			<li><a href="M/TheCollection.php" id="s_collection"><span>The Collection</span></a></li>
	...
	<div id="contentbox">
		<div id="content"> 
			<!--  content well begins --> 
			<a href="M/TheFragrance.php"><img src="_images/mariah_default.jpg" alt="Mariah Carey" width="430" height="504" border="0" /><img src="_images/mbrand/mbrand_main.jpg" alt="M by Mariah Carey" width="430" height="504" border="0" /></a> 
			<!--  content well ends --> 
		</div>
		<!-- sign up buttons -->
