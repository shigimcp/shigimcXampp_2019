...
//        const carousel    = $('<div class="carousel-container"><span class="prev controll"></span><div class="carousel-inner"><ul class="slider"></ul></div><span class="next controll"></span></div>');
        const carousel    = $('<div class="carousel-container"><h1>#CurveYourReality</h1><div class="carousel-inner"><ul class="slider"></ul></div></div>');
...
//                return `<iframe width="820" height="380" src="https://www.youtube.com/embed/${mainVideo}" frameborder="0" allowfullscreen></iframe><h2>${entries[0].snippet.title}</h2>`;
                return `<iframe src="https://www.youtube.com/embed/${mainVideo}?autoplay=1&rel=0" frameborder="0" allowfullscreen></iframe>`;
//                return `<iframe src="https://www.youtube.com/embed/${mainVideo}?rel=0" frameborder="0" allowfullscreen></iframe>`;
            });
...
//            $('.placeholder iframe').attr({"src" : `https://www.youtube.com/embed/${self.getId(url)}?autoplay=1`});
            $('.placeholder iframe').attr({"src" : `https://www.youtube.com/embed/${self.getId(url)}?autoplay=1&rel=0`});
